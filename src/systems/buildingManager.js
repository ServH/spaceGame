...
const BuildingManager = {
    ...
    showCompletionEffect(planet, buildingId) {
        ...
        // Animate effect using PerformanceManager if available
    ...
    getAIBuildingChoice(planet) {
        ...
        if (!Buildings.canBuildOnPlanet('shipyard', planet)) return null;

        const aiResources = { metal: planet.aiMetal || 0, energy: 100 };
        const choices = [];
    ...
    tryAIConstruction(planet) {
        ...
        planet.buildings[choice.buildingId] = {
            ...
            progress: 0,
            startTime: Date.now(),
            buildTime: building.buildTime * 0.8
        };
