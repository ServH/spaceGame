// AI Controller - ENERGY AS FUEL SYSTEM V2.5 CONSOLIDATED
// Unified AI system with enhanced strategies and building management
// Consolidation of js/ai.js + js/enhancedAI.js functionality
...
const AI = {
    ...
    init() {
        ...
        console.log('🤖 AI initialized - ENERGY AS FUEL SYSTEM (Enhanced V2.5)');
    },
    ...
    makeDecision() {
        // Check for game mode specific decisions
        if (typeof GameModes !== 'undefined' && GameModes.current === 'kingOfHill') {
    ...
    // King of Hill specific AI decision making
    makeKingOfHillDecision() {
        const hill = GameModes?.modes?.kingOfHill?.hillPlanet;
        if (!hill) return this.makeDecision();
