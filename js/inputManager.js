...
window.debugInput = {
    ...
    moduleStats: () => {
        const totalSize = {
            'Old input.js': '21.3KB',
            'mouseHandler.js': '6.4KB',
            'keyboardHandler.js': '3.8KB', 
            'uiFeedback.js': '6.4KB',
            'inputManager.js': '6.0KB'
        };
        console.log('📊 Modular Refactor Stats:', totalSize);
        console.log('💡 Total new size: ~22.6KB vs old 21.3KB (slight increase for better organization)');
